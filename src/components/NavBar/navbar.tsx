...
function navbar() {
  ...
  return (
    <div className="main flex justify-between items-center py-8 px-5 md:w-9/12 mx-auto">
      ...
      <a href={require("../../assets/AhmadNasaiei_Resume.pdf")} download="AhmadNasaiei_Resume"><button className='hidden md:flex px-6 py-2 border-2 border-ascent text-ascent rounded-full hover:bg-ascent hover:text-bg duration-150'>RESUME</button></a>
